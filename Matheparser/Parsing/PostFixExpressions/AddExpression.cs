...
namespace Matheparser.Parsing.PostFixExpressions
{
    ...
    public sealed class AddExpression : IPostFixExpression
    {
        ...
        public IValue Eval(IValue[] operands)
        {
            ...
            if(operands[0].Type == ValueType.String && operands[1].Type == ValueType.String)
            {
                return new StringValue(string.Concat(operands[0].AsString, operands[1].AsString));
            }
